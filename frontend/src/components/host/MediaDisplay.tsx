...
export default function MediaDisplay({
  ...
  const [isHidden, setIsHidden] = useState(!media.autoplay);
  ...
  return (
    <>
      {/* Media player container - hidden when isHidden is true */}
      {!isHidden && (
        <div className={containerClass}>
          <div className="flex flex-col items-center gap-4 p-4">
            ...
            <div className="relative flex items-center justify-center">
              ...
              {/* Control Buttons Overlay - Top Right of media */}
            ...
            {/* Buttons Below Player - Second Child */}
            {!isMaximized && (
              <div className="flex gap-3 items-center justify-center">
                {media.allowReplay && !isPlaying && (
                  <button
                    onClick={handleReplay}
                    className="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg shadow-lg transition-all duration-200 font-semibold flex items-center gap-2"
                ...
                {onComplete && (
                  <button
                    onClick={handleClose}
                    className="bg-purple-600 cursor-pointer hover:bg-purple-700 text-white px-6 py-2 rounded-lg shadow-lg transition-all duration-200 font-semibold text-lg"
            ...
            {/* Continue Button in maximized mode */}
            {onComplete && isMaximized && (
              <div className="absolute top-2 left-2">
                <button
                  onClick={handleClose}
                  className="bg-purple-600 cursor-pointer hover:bg-purple-700 text-white px-4 py-2 rounded-lg shadow-lg transition-all duration-200 font-semibold"
                  title={t.media.continue}
                >
                  {t.media.continue}
                </button>
